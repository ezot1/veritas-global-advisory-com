...
const CSP = [
  ...
  "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.gpteng.co https://translate.google.com https://translate.googleapis.com https://www.gstatic.com",
  `connect-src 'self' ${SUPABASE_URL} ${SUPABASE_WS} https://*.lovable.app https://*.lovable.dev https://translate.googleapis.com`,
